...
class CustomerRepository {
	...
	async AddWishlistItem(customerId, { _id, name, desc, price, isAvailable, banner }){

		const product = {
			_id, name, desc, price, isAvailable, banner
		};
	...
	async AddCartItem(customerId, { _id, name, desc, price, isAvailable, banner }, qty, isRemove){
		...
		try{
			...
			if(profile){
				...
				const cartItem = {
					product: { _id, name, desc, price, isAvailable, banner },
					unit: qty,
				};
			...
			throw new APIError('API Error', STATUS_CODES.INTERNAL_ERROR, "Unable to add item to cart.");
		}
